Linode Longview - Configurable endpoint
===============
...
This fork adds the ability to configure the end point in use by the Longview agent by editing the config.yaml file in the configuration directory.
